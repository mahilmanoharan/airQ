...
struct DashboardView: View {
    ...
    private func loadedView(data: AirQuality) -> some View {
        VStack(spacing: 24) {
            Spacer()
...
//#Preview("With Mock Location") {
//    let vm = DashboardViewModel()
//    // Set mock location immediately
//    Task { @MainActor in
//        vm.locationManager.location = CLLocationCoordinate2D(latitude: 37.7749, longitude: -122.4194)
//    }
//    return DashboardView()
//}
//
//#Preview("Loaded State - Good Air Quality") {
//    let vm = DashboardViewModel()
//    let mockData = AirQuality(
//        status: "ok",
//        data: AQData(
//            aqi: 42,
//            idx: 123,
...
//                name: "San Francisco",
//                url: "https://aqicn.org/city/sanfrancisco",
//                location: "California, USA"
//            ),
//            dominentpol: "pm25",
//            iaqi: IAQI(co: nil, h: nil, no2: nil, o3: nil, p: nil, pm10: nil, pm25: IAQIValue(v: 42), so2: nil, t: nil, w: nil, dew: nil, wg: nil),
//            time: TimeData(s: "2026-04-19 12:00:00", tz: "-07:00", v: 1713528000, iso: "2026-04-19T12:00:00-07:00"),
//            forecast: nil,
//            debug: nil
//        )
//    )
//    vm.state = .loaded(mockData)
//    
//    return ContentPreviewWrapper(vm: vm)
//}
//#Preview("Error State") {
//    let vm = DashboardViewModel()
//    vm.state = .error("Network error occurred")
//    return ContentPreviewWrapper(vm: vm)
//}
//
//// Helper wrapper for previews
//private struct ContentPreviewWrapper: View {
//    let vm: DashboardViewModel
//    
//    var body: some View {
//        ZStack {
//            switch vm.state {
//            case .loaded(let data):
//                Color(aqiColor(for: data.data.aqi).opacity(0.05))
//                    .ignoresSafeArea()
//            default:
...
//    }
//    
//    private func loadedContent(data: AirQuality) -> some View {
//        VStack(spacing: 24) {
//            Spacer()
//            
//            VStack(spacing: 8) {
